use dioxus::prelude::*;
use plural_export::{Export, ExportType};
...
fn convert(input: &str, format: &str) -> (String, Option<String>) {
    ...
    let converted = match export_type {
        ExportType::PluralKitV1 => export.inner_into_pluralkit_v1(),
        ExportType::PluralKitV2 => export.inner_into_pluralkit_v2(),
        ExportType::Tupperbox => export.inner_into_tupperbox()
    };
